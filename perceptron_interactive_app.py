...
dataset = st.sidebar.selectbox("Dataset", ["1: linearly separable", "2: non-separable (noisy)"])
...
user_intercept = st.sidebar.slider("Your line intercept (b)", min_value=0.0, max_value=120.0, value=50.0, step=0.5)
